...
void updateLEDs(){
  if (SD_connection_status && I2C_connection_status && Lidar_connection_status && GPS_connection_status) setWhite(); 
  else if (!SD_connection_status && !I2C_connection_status && !Lidar_connection_status && !GPS_connection_status) setRed();
