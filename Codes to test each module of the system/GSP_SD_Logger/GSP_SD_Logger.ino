...
#define NEW_FILE_TIME 30000  //milliseconds to make a new file 
...
void logData() {
  if (dataFile) {
    ...
    dataFile.print(" Lat: ");
    dataFile.print(latitude, 6);  // Printing with precision
    dataFile.print(" Lon: ");
    dataFile.print(longitude, 6);  // Printing with precision
    dataFile.print(" Speed: ");
    dataFile.print(speed_knots, 2);
    dataFile.print(" knots (");
    dataFile.print(speed_kmh, 2);
